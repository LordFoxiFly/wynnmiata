    ...
    public void onHudRender(DrawContext drawContext, RenderTickCounter tickCounter) {
        ...
        if (WynnMiata.CONFIG.isArmorDurabilityBoolean() && WynnMiata.CONFIG.isRenderHudElements()){
            ...
            if (MinecraftClient.getInstance().player.getEquippedStack(EquipmentSlot.CHEST).isEmpty()){
                drawContext.drawTexture(EMPTY_CHESTPLATE, WynnMiata.CONFIG.getArmorDurabilityX() , WynnMiata.CONFIG.getArmorDurabilityY() +20, 0, 0, 15, 15, 15, 15);
            }
            else{
            ...
            if (MinecraftClient.getInstance().player.getEquippedStack(EquipmentSlot.LEGS).isEmpty()){
                drawContext.drawTexture(EMPTY_LEGGINGS, WynnMiata.CONFIG.getArmorDurabilityX() , WynnMiata.CONFIG.getArmorDurabilityY() + 40, 0, 0, 15, 15, 15, 15);
            }
            else{
            ...
            if (MinecraftClient.getInstance().player.getEquippedStack(EquipmentSlot.FEET).isEmpty()){
                drawContext.drawTexture(EMPTY_BOOTS, WynnMiata.CONFIG.getArmorDurabilityX() , WynnMiata.CONFIG.getArmorDurabilityY() + 60, 0, 0, 15, 15, 15, 15);
            }
            else{
